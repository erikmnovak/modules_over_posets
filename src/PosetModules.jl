...
# Bring the derived-functor API into the umbrella namespace so the `export` list
# below refers to actual bindings (not undefined names in PosetModules).
using .DerivedFunctors: ProjectiveResolution, InjectiveResolution,
    projective_resolution, injective_resolution, betti, bass,
    ExtSpaceProjective, ExtSpaceInjective, ExtSpace,
    Ext, ExtRepresentative, representative, basis, dim, cycles, boundaries,
    ext_map_first, ext_map_second, connecting_hom,
    YonedaElement, yoneda_product,
    ExtAlgebra, ExtElement,
    ExtSpace, ExtRepresentative, YonedaElement, 
    tor_map_first, tor_map_second,
    TorSpace, Tor, tor_map_first, tor_map_second,
    pmodule_on_box, ExtZn,
...
export Face, IndFlat, IndInj, Flat, Injective, Flange, canonical_matrix, dim_at, bounding_box,
...
export Hom, Ext, ExtInjective,
       ...
       betti, betti_table,        
       bass, bass_table,             
       Tor, ExtZn, pmodule_on_box,
       ExtAlgebra, ExtElement, element, unit, multiply, precompute!,
       ProjectiveMinimalityReport, InjectiveMinimalityReport,
       minimality_report, is_minimal, assert_minimal,
       minimal_projective_resolution, minimal_injective_resolution,
       minimal_betti, minimal_bass
