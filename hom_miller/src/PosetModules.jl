...
#   4) Exact rational linear algebra (exact RREF, rank, etc.)
...
# ----------------------- Re-exports for a nice user-facing API ----------------
using .CoreModules
using .FiniteFringe
...
export HPoly, PolyUnion, PLUpset, PLDownset, encode_from_PL_fringe,
       cross_validate
